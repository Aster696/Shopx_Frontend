		...
		<sp:form modelAttribute="game" action="${pageContext.request.contextPath}/game/addGame" method="post" enctype="multipart/form-data">
			...
			<table>
				<tr>
					...
					<td>
						<sp:input type="text" path="game_name" placeholder="Enter the Name of the Game" size="45"/>
				...
				<tr>
					...
					<td>
						<sp:input type="email" path="email" placeholder="Enter Email of your Company" size="45"/>
				...
				<tr>
					...
					<td>
						<sp:input type="text" path="brand" placeholder="Enter your Brand name" size="45"/>
				...
				<tr>
					...
					<td>
						<sp:textarea path="description" placeholder="Enter the Game Description" style="resize: none;" rows="3" cols="48"></sp:textarea>
				...
				<tr>
					...
					<td>
						<sp:input type="text" path="link" placeholder="Enter game website Link" size="45"/>
						<sp:errors path="link"/>
					</td>
				</tr>
